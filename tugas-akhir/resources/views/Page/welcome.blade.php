...
<head> <!-- Mulai kepala dokumen HTML -->
    ...
    <title>Welcome</title> <!-- Judul halaman web yang akan ditampilkan di tab peramban -->
</head> <!-- Akhir kepala dokumen HTML -->
<body> <!-- Mulai tubuh dokumen HTML -->
    <h1> Selamat Datang {{$namaDepan}} {{$namaBelakang}}</h1> <!-- Teks judul level 1 dengan penggunaan variabel PHP -->
    <h2>Lengkapi kebutuhan kulitmu, hanya disini!</h2> <!-- Teks judul level 2 -->
